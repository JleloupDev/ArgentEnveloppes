...
class _EnvelopeDetailPageState extends ConsumerState<EnvelopeDetailPage> {
  ...
  void initState() {
    super.initState();
    // TODO: Charger les transactions de l'enveloppe
  }  @override
                      ...
                      children: [
                        ...
                        Expanded(
                          child: _buildInfoColumn(
                            ...
                            envelope.remaining < 0 ? AppColors.error : null,
                          ),
                        ),
                      ],
                    ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              // TODO: Mettre à jour l'enveloppe
